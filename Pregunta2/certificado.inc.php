...
<?php
    ...
    <div class="d-flex justify-content-center align-items-center bg-dark">
        <h1 class="text-white w-100 text-center p-5 fw-bold">Comprar certificado</h1>;
    ...
    <div class="d-flex jusitify-content-center align-items-center mt-4">
        <div class="w-100">
            <p class="text-center">Al aprobar el curso prefacultativo o examen de admicion debemos de comprar el certificado de aprobacion en la carrera postulante y llenarla</p>
        </div> 
    </div>
    </div>
