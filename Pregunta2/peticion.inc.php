...
<?php
    ...
    <div class="d-flex justify-content-center align-items-center bg-dark">
        <h1 class="text-white w-100 text-center p-5 fw-bold">Pedir certificado de conclusion</h1>;
    ...
    <div class="d-flex jusitify-content-center align-items-center mt-4">
        <div class="w-100">
            <p class="text-center">Para iniciar el proceso de peticion de certificado debe de dar en el boton de siguiente.</p>
        </div> 
    </div>
    </div>
    <?php
